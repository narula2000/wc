...
class TestMain:
    ...
    def test_file_input(self, capsys):
        ...
        main(test_args)
        output = capsys.readouterr().out
        assert "7145  58164  342190 test.txt" == output
